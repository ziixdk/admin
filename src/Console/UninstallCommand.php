...
class UninstallCommand extends Command
{
    ...
    {
        if (!$this->confirm('Are you sure to uninstall ziix-admin?')) {
            return;
        }

        $this->removeFilesAndDirectories();

        $this->line('<info>Uninstalling ziix-admin!</info>');
    }
    ...
    protected function removeFilesAndDirectories()
    {
        ...
        $this->laravel['files']->deleteDirectory(public_path('vendor/ziix-admin/'));
