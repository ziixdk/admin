 ...
 * Class Admin.
 *
 * @method static \ZiiX\Admin\Grid                                                     grid($model, \Closure $callable)
 * @method static \ZiiX\Admin\Form                                                     form($model, \Closure $callable)
 * @method static \ZiiX\Admin\Show                                                     show($model, $callable = null)
 * @method static \ZiiX\Admin\Tree                                                     tree($model, ?\Closure $callable = null)
 * @method static \ZiiX\Admin\Layout\Content                                           content(?\Closure $callable = null)
 ...
 *
 * @see \ZiiX\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \ZiiX\Admin\Admin::class;
    }
}
