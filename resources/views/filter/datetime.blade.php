...
<div class="admin-input-group">
    ...
    <input class="bg-gray-50 border border-s-0 border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block rounded-e-lg w-full p-2.5"
        id="{{ $id }}" placeholder="{{ $label }}" name="{{ $name }}" value="{{ request($name, $value) }}">
</div>
