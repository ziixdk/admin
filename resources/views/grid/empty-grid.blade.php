<tr>
    <td colspan="{{ $grid->visibleColumns()->count() }}" class="px-4 py-16 text-center">
        <div class="flex flex-col items-center gap-3 text-gray-400">
            <svg class="w-16 h-16" fill="currentColor" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="text-sm">{{ trans('admin.no_data') }}</p>
        </div>
    </td>
</tr>
